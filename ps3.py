...
def update_hand(hand, word):
    ...
    for c in word:
        if c in new_hand and new_hand[c] == 1:
            del(new_hand[c])
        elif c in new_hand and new_hand[c] > 1:
            new_hand[c] -= 1
...
def is_valid_word(word, hand, word_list):
    ...
    if '*' in word:
        ...
        if not any(p_word in word_list for p_word in possible_words):
            return False
    else:
    ...
    for c in freq:
        if c not in hand or freq[c] > hand[c]:
            return False
...
def substitute_hand(hand, letter):
    ...
    for c in hand_letters:
        possible_letters = possible_letters.replace(c, "")
    ...
    if letter in new_hand:
        ...
        new_hand[random.choice(possible_letters)] = letter_number
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    for i in range(total_hands):
        ...
        print(f"Total score after {i+1} hands: {total_score} points.\n")
